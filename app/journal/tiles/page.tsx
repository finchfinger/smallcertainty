...
export const metadata:Metadata={
  ...
  description:"A tiled view of Small Certainty journal entries.",
  alternates:{ canonical:"/journal/tiles" },
  openGraph:{
    title:"Journal Tiles — Small Certainty",
    description:"A tiled view of Small Certainty journal entries.",
    url:"/journal/tiles",
  },
};
...
export default async function JournalTilesPage(){
