...
const textBlocks:PortableBlock[]=[
  ...
  block("patagonia-history-intro-2","normal","For Chouinard, the best thing was never simply the most expensive, the newest or the most technically crowded. It was the thing most completely fitted to its use: strong enough to trust, simple enough to understand, repairable when possible and honest about the conditions of its manufacture. Each enlargement of Patagonia made that standard harder to maintain. It also made the consequences of getting it wrong more visible. The history of the company is therefore a sequence of corrections, in which a good product repeatedly forces its maker to reconsider what good is allowed to mean."),
  ...
  block("patagonia-history-quality-2","normal","This is the most convincing part of Patagonia’s environmental position because it does not require a perfect material or an innocent supply chain. Neither exists. It asks instead whether the object earns the resources already spent on it and whether the maker remains responsible after the sale. Field testing, the Ironclad Guarantee, repair technicians and Worn Wear all extend design beyond launch day. A torn sleeve is not merely evidence that a jacket failed. It is information about construction, an invitation to repair and, if the company is paying attention, a note for the next pattern."),
  ...
  block("patagonia-history-business-heading","h2","THE COMPANY AS A TOOL"),
  block("patagonia-history-business-1","normal","The company’s environmental commitments accumulated in the same manner: a tax on itself, support for small activist organisations, transparency about factories, experiments in recycled fibres, repair and resale. They did not form a clean ascent towards virtue. Patagonia continued to make new things, ship them around the world and grow. Chouinard was unusually willing to describe that contradiction without resolving it into a slogan. The business was not proof that commerce could be harmless; it was a tool with enough reach, money and technical competence to make some forms of harm harder to ignore."),
  block("patagonia-history-business-2","normal","This distinction protected the products from becoming mere carriers of a cause. A Patagonia jacket still had to be a very good jacket. Environmental intent could sharpen the choice of fibre or increase the reason to repair, but it could not excuse a poor zip, a confused pocket or a silhouette that aged badly. Chouinard’s achievement was to make product quality and environmental responsibility increasingly difficult to separate. Longevity became a form of restraint; restraint became a design criterion; and the company’s activism gained credibility from objects that people were reluctant to throw away."),

  block("patagonia-history-ownership-heading","h2","THE LAST PRODUCT WAS THE COMPANY"),
  block("patagonia-history-ownership-1","normal","By 2022 the unresolved object was Patagonia itself. A sale could enrich the family but expose the company’s principles to a new owner. A public offering would subject it to demands for short-term return. Chouinard, his wife Malinda and their children transferred the voting stock to the Patagonia Purpose Trust and the nonvoting stock to the Holdfast Collective. Patagonia remained a profit-making business, but the trust was charged with protecting its purpose and the collective would receive the money left after reinvestment to support environmental work."),
  ...
  block("patagonia-history-conclusion-1","normal","Patagonia’s history is often told as the story of an ethical company. It is more useful as the story of a demanding maker. Chouinard’s standards were not fixed because the evidence was not fixed. The piton that once improved safety later damaged the rock. The natural fibre later revealed an industrial agriculture. The durable jacket still carried the costs of manufacture. At each stage, quality became a larger and less comfortable idea. The object had to perform, but performance now included what happened before it reached the customer and after the customer had finished with it."),
  block("patagonia-history-conclusion-2","normal","That approach offers no final certification and Patagonia should not be granted one. The company remains inside the contradictions of production and growth. Its example lies elsewhere: in treating the discovery of a flaw as a design brief rather than a public-relations emergency. Chouinard kept trying to make the best thing possible, then allowed the meaning of best to be corrected by the world around it. The ambition was not perfection. It was the refusal to regard yesterday’s improvement as permission to stop looking."),
];
...
async function main(){
  ...
  const patch={
    ...
    dek:"Before Patagonia became shorthand for responsible business, Yvon Chouinard was a blacksmith trying to make safer climbing tools. The company that followed kept enlarging his definition of what the best possible thing required.",
    content,
  };
