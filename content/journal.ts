...
export const journalArticles:JournalArticle[]=[
  ...
  },
  {
    ...
    imageSrc:"/journal/features/john-morgan-portrait.webp",
    author:"Small Certainty",
    sections:johnMorganSections,
    content:[
      {_key:"morgan-opening",_type:"articleTextSection",body:johnMorganSections[0].body},
      {_key:"morgan-portrait",_type:"imageArrangement",layout:"centered",primaryImage:{url:"/journal/features/john-morgan-portrait.webp",alt:"Portrait of graphic designer John Morgan holding a publication in front of his face",caption:"John Morgan, photographed for Eye magazine",credit:"Blommers & Schumm / Eye 83"}},
      ...
      {_key:"morgan-public-work",_type:"imageArrangement",layout:"split",primaryImage:{url:"/journal/features/john-morgan-aa-files.webp",alt:"AA Files covers and editorial spreads designed by John Morgan studio",caption:"AA Files: scholarly material given pace, weight and shelf life",credit:"John Morgan studio / Eye 83"},secondaryImage:{url:"/journal/features/john-morgan-raven-row.webp",alt:"Raven Row identity and exhibition graphics by John Morgan studio",caption:"Raven Row: typography operating at the scale of rooms and streets",credit:"John Morgan studio / Eye 83"}},
      ...
      {_key:"morgan-gallery",_type:"imageArrangement",layout:"full",primaryImage:{url:"/journal/features/john-morgan-gallery.webp",alt:"Hidde van Seggelen Gallery identity and printed matter designed by John Morgan studio",caption:"Hidde van Seggelen Gallery: an identity allowed to change scale without losing character",credit:"John Morgan studio / Eye 83"}},
